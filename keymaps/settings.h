...
// #define KB_EMULATION_ERGOL            // assumes the host is in QWERTY-intl
// or AZERTY #define KB_EMULATION_QWERTY_LAFAYETTE // assumes the host is in
// QWERTY-intl or AZERTY
